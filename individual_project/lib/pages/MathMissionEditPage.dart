...
double value = 1;
String level = LocaleKeys.easy_text.tr();
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text(
                          LocaleKeys.choose_math_mission_text.tr(),
                          style: TextStyle(
                                      ...
                                      child: Slider(
                                          ...
                                          onChanged: (_value) {
                                            setState(() {
                                              ...
                                              if (value == 1) {
                                                level =
                                                    LocaleKeys.easy_text.tr();
                                              }
                                              if (value == 2) {
                                                level =
                                                    LocaleKeys.normal_text.tr();
                                              }
                                              if (value == 3) {
                                                level =
                                                    LocaleKeys.hard_text.tr();
                                              }
                                            });
                                            print(level);
                                            print(value);
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          child: TextButton(
                            onPressed: () {
                              MissionAddHelper.addToMissionFull(
                                  2, int.parse(items[index]), value.toInt());
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
